...
const AIGuideCover: React.FC = () => {
  return (
    <div className="w-full h-full bg-gradient-to-br from-blue-600 to-purple-700 rounded-lg shadow-lg p-3 text-white">
      <div className="border-2 border-white/20 rounded-lg p-2 h-full flex flex-col justify-between">
